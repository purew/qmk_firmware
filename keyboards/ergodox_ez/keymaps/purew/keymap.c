...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_DEL,          GUI_T(KC_QUOT),        KC_COMM,          KC_DOT,    KC_P,    KC_Y,    TG(SYMB),             TG(SYMB),     KC_F,    KC_G,    KC_C,    KC_R,              KC_L,           KC_EQL,
  KC_BSPC,         KC_A,        KC_O,          KC_E,    KC_U,    KC_I,                                        KC_D,    KC_H,    KC_T,    KC_N,    LT(MDIA, KC_S), GUI_T(KC_MINS),
  KC_LSFT,         CTL_T(KC_SCLN), KC_Q,          KC_J,    KC_K,    KC_X,    HYPR_T(KC_NO),                 MEH_T(KC_SLSH), KC_B,    KC_M,    KC_W, KC_V,           CTL_T(KC_Z), KC_RSFT,
  LT(SYMB,KC_GRV), KC_QUOT,     LALT(KC_LSFT), KC_LEFT, KC_RGHT,                                              KC_UP,   KC_DOWN, KC_LBRC, KC_RBRC, TT(SYMB),
                                                           ALT_T(KC_APP), KC_LGUI,                KC_LALT, CTL_T(KC_ESC),
                                                                          KC_HOME,                 KC_PGUP,
                                                         KC_SPC, KC_BSPC, KC_END,                  KC_PGDN, KC_TAB, KC_ENT

    // TODO: KC_BSLS, GUI_T(KC_QUOT), LT(MDIA, KC_SCLN)
    //
),
